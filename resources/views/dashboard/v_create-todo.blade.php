...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md">
            <div class="card">
                <div class="card-header">{{ __('Create Todolist') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{route('create-todo.store')}}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="progress" type="number" class="form-control @error('progress') is-invalid @enderror" name="progress" value="{{ old('progress') }}" autocomplete="progress" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="comment" id="comment" class="form-control @error('comment') is-invalid @enderror" autocomplete="comment" autofocus>{{ old('comment') }}</textarea>
